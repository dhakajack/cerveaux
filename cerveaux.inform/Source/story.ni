...
To say firstUnlocked:
	...
	say "[paragraph break][quotation mark][italic type]Attends, dit le chien. Quel est ce nouveau truc?[line break]-- Il faut introduire un code pour ouvrir les portes avec des serrures électroniques.[line break]-- Et tu te souviens de ce code? demande la souris.[line break]-- Apparemment[roman type].[quotation mark]".
...
After eating the chien:
	...
	say "Par instinct, vous dévorez son cerveau et jetez le corps dans la cage. Encore une fois, de nouvelles pensées envahissent votre esprit.[paragraph break][italic type]Je vous préviens: si vous approchez de ma cage, je vous mordrai. Arrêtez! Sans blague… [paragraph break]Mais, qu'est-ce qui se passe? De quoi s'agit le chien mort dans ma cage… qui coule du sang sur mon coussin préféré?[paragraph break]Et pourquoi est-ce que je me tiens debout sur deux jambes à la façon des êtres humains? C'est en fait plus facile que j'aurais pensé.";
	increment the consciousness of the player;
	increment the knownCommands of the player.
...
After eating Docteur Rambaud:
	now the BlockChatterFlag is true;
	say "Vous dévorez le cerveau de la scientifique. Immédiatement vous voyez le monde d'un point de vue plus raffiné et érudit.[paragraph break][quotation mark][italic type]C'est fait? demande la voix d'Isabelle avec hésitation.[line break]-- Oui, tu étais délicieuse, enthousiasme le souris.[line break]-- Le meilleur jusqu'ici, ajoute Lucky.[line break]-- Excuse mes co-esprits, ils manquent cruellement de tact, intervient la tranche de cerveau.[line break]-- Hé! gémissent la souris et le chien.[line break]-- Sois la bienvenue, Isabelle, continue la tranche de cerveau. Laisse-moi présenter notre petite troupe: voilà Lucky, le chien, et ici figure Le Marquis Des Souris (ou juste simplement [apostrophe]Souris[apostrophe] parce qu'il est plutôt modeste), et moi, je suis le nommé [apostrophe]tranche de cerveau[apostrophe]. On est à ta disposition.[line break]-- Bonjour, les gars, dit Isabelle avec chaleur.[quotation mark][paragraph break]";
...
"Je n'arrive pas à comprendre exactement comment j'ai réussi à vous manger.[line break]-- Qu'est-ce que tu te rappelles de l[apostrophe]événement?[line break]-- J[apostrophe]étais pris d'une folle envie de cerveaux.[line break]-- Quel cerveau?[line break]-- Dans ce cas, le tien.[line break]-- Ah, je vois.",
...
"Dehors? demande la souris. Je suis tout à fait confortable ici. Que offre le monde extérieur? Rien que des ennuis. J'ai hérités des terres ici et même un titre -- vous rendez-vous compte que je suis un marquis? Oui, je ne plaisante pas. Je suis le dix-huitième marquis de ma ligne. Tu veux que je sacrificie tout ça?[line break]-- Il y a un monde entier! plaide le chien[line break]-- J'ai vécu là, ajoute la tranche de cerveau. Je crois que je vivais non loin d'ici avec ma copine… comment s'appelait-elle?", 
...
"Tu dis que tu as vu dans les pensées de Lucky? demand la souris. Comment est-ce possible?[line break]-- Nous faisons tous parti d'un seul cerveau maintenant. Nos esprits sont d'une manière ou d'une autre mélangés. Je peux accéder aux ses pensées et il peut également accéder aux miennes.[line break]-- Cool! dit le souris. Nous avons des superpouvoirs!",
"Je trouve cela un peu improbable, dit le chien. Si tu peux voir dans mes pensées, de quel numéro est-ce que je pense en ce moment?[line break]-- Le scientifique réfléchisse un moment et elle dit, le numéro un.[line break]-- Oui, c'est exact, admet le chien, mais peut-être que tu y es arrivée par hasard. Essaie encore une fois…[line break]-- Tu penses du numéro deux, dit le scientifique avec conviction.[line break]-- Oui encore, dit le chien satisfait.[line break]-- Mais, objet le souris, Lucky ne sait que deux numéros… qu'est-ce que ça prouve?",
"Je n'ai jamais souhaité être autre qu'un souris. Je trouve cela terrifiant, que mon esprit puisse être dilué.[line break]-- Mais vois les avantages, dit Lucky. Regarde dans mes pensés -- voici comment je me sens en chassant un écureuil. Et voici la sensation d[apostrophe]être gratté entre les oreilles.[line break]-- Oui, je suppose.[line break]-- Et ici, dit le scientifique, je te montre la Terre vue depuis l'espace -- quelque chose qu'aucune souris n'a jamais vu.[line break]-- Heu. C'est impressionnant. Et je suppose que de ma part j'ai quelque souvenirs pour partager aussi: le chaleur de dormir avec les autres souris, la joie de voler le bribes du distributeur de Lucky…[line break]-- Hé! hurle le chien.", 
"Quand j'ai vu le corps de Julien entrer dans le sas, j'ai remarqué qu'il déplaçait avec difficulté, marchant lentement et trébuchant, dit le scientifique.[line break]-- Oui, je sais comment marcher, dit la tranche de cerveau, mais je le trouve désespérément difficile de le mettre en pratique.[line break]-- La souris n'aide pas, commente Lucky. Il bouge toujours les jambes.[line break]-- Moi? dit le souris avec indignation. C'est toi qui veut toujours aller à quatre pattes.[line break]-- OK, dit le scientifique, puis-je vous convaincre qu'une personne doit pilote le corps à la fois?[line break]-- Oui, certainement, acquiesce la tranche de cerveau. Le volant est à toi.", 
"D'accord, dit le scientifique. Je m'empresse de faire ce qu'il faut pour obtenir le remède.[line break]-- Bon. Assez de papotage mes amis, laissez-la concentrer, conseil la tranche de cerveau.[line break]-- Oui, d'accord, disent le chien et la souris."
}
...
CuredDialogue is { 
"C'est fait, dit le scientifique. Je ferai l'appel: Lucky?[line break]-- Présent.[line break]-- Le Marquis de Souris?[line break]-- Oui. Ici.[line break]-- Et, la tranche de cerveau de Julien?[line break]-- Présent.[line break]-- Bon, dit Isabelle, il me semble que nous sommes tous arrivées sauf et sain.",
"Et maintenant on quitte la installation? suggère le chien.[line break]-- Oui, dit Isabelle[line break]-- Mais la porte extérieur est verrouillée. Personne ne peut l'ouvrir à part le colonel Greillier dans la salle de contrôle.[line break]-- Oui, nous devons le convaincre de l'ouvrir, acquiesce le scientifique.",
...
"Bon, Julien, il me semble que tu es en train de récupérer ta mémoire, dit le scientifique.[line break]-- Tu penses? Pourtant tu m'as dite que je ne suis qu'une toute petite biopsie de cerveau. Est-il possible que les souvenirs sont les tiens et je les lis dans tes pensées?[line break]-- Je dirais qu'une toute petite biopsie ne serait à guère capable de hasarder une telle hypothèse, plutôt il s'agit d'un cerveau entier en pleine forme.",
"Si j'ai bien compris, dit Lucky, tu as dit que les cerveaux des zombies sont complètement effacés par le virus. Vu que rien ne reste, comment se fait-il qu'il peut fonctionner maintenant?[line break]-- Nous n'avons jamais eu un pareil cas pour étudier, répond le scientifique. Il est temps de réviser notre compréhension du processus: il semble que les cerveaux ne sont pas détruits, mais plutôt supprimés. Ses voies neuronales ont toujours étés intactes. En fait, c'est grâce à eux que nous continuons à exister du tout. Nous nous servons de ces voies pour formuler nos propres pensées.",
"C'est super! dit Julien. On peut restaurer tous les zombies![line break]-- Mon dieu, Julien, vous avez raison. Ils ne sont plus perdus, répond le scientifique. Pour la première fois, il y a un espoir de restaurer le monde et terminer ce cauchemar.[line break]-- Même les chiens infectés? demande Lucky.[line break]-- Oui, y compris les chien et toutes les autres espèces infectés par le virus, répond le scientifique.",
"Alors, que faire? demande la souris.[line break]-- Dépêchons-nous au sas, dit Isabelle. Julian, il faut parler avec le colonel pour le convaincre que tu es guéri et que nous possédons un remède contre le virus.[line break]D'accord. Je ferai	 mon mieux, dit Julien.[line break]-- Allons-y! crie la souris."
}.
